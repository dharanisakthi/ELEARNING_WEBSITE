...
<tr><td><div class="container"><img src="pics/1.jpg" alt="Snow">
  <button class="btn" onclick="window.location.href = 'pgmg.php';">PROGRAMMING LANGUAGES</button></div></td>
...
<td><div class="container"> <img src="pics/3.jpg" alt="Snow">
  ...
  <!--<tr><td><br></td></tr> -->
   <tr><div class="container"><img src="pics/7.jpg" alt="Snow">
  <button class="btn" onclick="window.location.href = 'db.php';">DATABASE</button></div></td></tr>

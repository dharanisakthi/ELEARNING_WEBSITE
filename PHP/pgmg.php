...
<html lang="en">
 <head>
  ...
  <body data-spy="scroll" data-target=".navbar" data-offset="50" style="background-image:url('pics/b.jpg'); background-repeat:no-repeat; background-size:COVER; padding-top:2%;">
    ...
    <BR><BR><BR><BR><BR><BR>
    <table align="center" border-spacing="20px" cellspacing="20px" cellpadding="10px">
      <tr>
        <td><div class="container"><img src="pics/2.jpg" alt="C">
          <button class="btn">
            C<BR>
            <a href="https://youtu.be/8PopR3x-VMY">Go to course</a>
          </button></div>
        </td>      
        <td><div class="container"><img src="pics/4.jpg" alt="C++">
          <button class="btn">
            C++<BR>
      ...
      <tr><td><br></td></tr>
      <tr>
        <td><div class="container"> <img src="pics/3.jpg" alt="C#">
          <button class="btn">
            C#<BR>
            <a href="https://youtu.be/wLg-XdAmrak">Go to course</a>
          </button></div>
        </td>
        <td><div class="container"> <img src="pics/7.jpg" alt="PYTHON">
          <button class="btn">
            PYTHON<BR>
      ...
      <tr><td><br></td></tr>
      <tr>
        <td><div class="container"> <img src="pics/7.jpg" alt="JAVA">
          <button class="btn">
            JAVA<BR>
